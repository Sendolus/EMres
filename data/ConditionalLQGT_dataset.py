...
class ConditionalLQGTDataset(data.Dataset):
    """
    ...
    def __getitem__(self, index):
        ...
        GT_path, LR_path, mask_path = None, None, None
        ...
        if self.opt["phase"] == "train":
            ...
            img_mask = img_mask[rnd_h : rnd_h + LR_size, rnd_w : rnd_w + LR_size]
        ...
        return {"LQ": img_LR, "GT": img_GT, "mask": img_mask, "LQ_path": LR_path, "GT_path": GT_path, "mask_path": mask_path}
