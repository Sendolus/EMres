...
class DenoisingModel(BaseModel):
    ...
    def optimize_parameters(self, step, timesteps, sde=None):
        ...
        xt_1_expection = sde.reverse_sde_step_mean(self.state[:, :3, :, :], score, timesteps)
        xt_1_optimum = sde.reverse_optimum_step(self.state[:, :3, :, :], self.state_0, timesteps)
    ...
    def test(self, sde=None, save_states=True):
        sde.set_mu(self.condition)
