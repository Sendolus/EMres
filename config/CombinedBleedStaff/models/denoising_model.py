...
class DenoisingModel(BaseModel):
    ...
    def optimize_parameters(self, step, timesteps, sde=None):
        ...
        xt_1_expection = sde.reverse_sde_step_mean(self.state[:, :6, :, :], score, timesteps)
        xt_1_optimum = sde.reverse_optimum_step(self.state[:, :6, :, :], self.state_0, timesteps)
    ...
    def test(self, sde=None, perform_ode=False, save_states=True):
        sde.set_mu(self.condition)
